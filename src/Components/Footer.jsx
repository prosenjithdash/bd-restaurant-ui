...
const Footer = () => {
    return (
        <footer className="max-w-[1920px] mx-auto px-4 divide-y bg-gray-100 text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full ">
                            <img className="rounded-full" src="https://i.ibb.co/DgYrJ6j/images-q-tbn-ANd9-Gc-S0a-Om-NG6-PSm19-FOSv4t-TJOw-CXnc6-Fi-QT9-WT6t05-LNA-s.png" alt="" />
                        </div>
                        <span className="self-center text-2xl font-semibold">BD Restaurant </span>
                    </a>
                </div>
